...
fields used by **cffr** and each one of the valid keys of the 
...
1.2.0](https://github.com/citation-file-format/citation-file-format/blob/main/schema-guide.md#valid-keys) [@druskat2021].
...
can retrieve the topics of your repo via the 
[GitHub API](https://docs.github.com/en/rest) and include those topics as 
keywords. This option is controlled via the `gh_keywords` parameter:
...
description on the 
[Guide to CFF schema v1.2.0](https://github.com/citation-file-format/citation-file-format/blob/main/schema-guide.md#type).
