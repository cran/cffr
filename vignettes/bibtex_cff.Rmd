...
Additionally, **cffr** [@hernangomez2021] incorporates a function
`cff_from_bibtex()` than can be used to read and transform BibTeX strings into
different formats:
...
[^7]: To avoid errors on the interpretation, names in **bold** correspond to
    BibTeX fields while the same number on [underscore]{.underline} would refer
    to CFF.
...
| BibTeX           | CFF                  | Note                              |
+==================+======================+===================================+
| **\@article**    | [type:               | When converting CFF to BibTeX,    |
|                  | article]{.underline} | [type                             |
...
| **number**       | [issue]{.underline}  |                                   |
+------------------+----------------------+-----------------------------------+
| **pages**        | [start]{.underline}  | Separated by `--`, i.e,           |
|                  | and                  |                                   |
|                  | [end]{.underline}    | **pages** = {3--5}                |
|                  |                      |                                   |
|                  |                      | would be parsed as                |
|                  |                      |                                   |
|                  |                      | [start]{.underline}: 3            |
...
|                  |                      | [end]{.underline}: 5              |
+------------------+----------------------+-----------------------------------+
| **month**        | [month]{.underline}  | As a fallback, **month** could be |
...
identify an **\@inbook** on CFF as a [book]{.underline} with
[section]{.underline} and [start]{.underline}-[end]{.underline} fields (CFF).

Another specificity is that **series** field is mapped to
[collection-title]{.underline} and **address** is mapped as the
[address]{.underline} of the [publisher]{.underline} (CFF).
...
+------------------------+--------------------------+--------------------------+
| **\@inbook**           | [type: book]{.underline} | For identifying an       |
|                        |                          | **\@inbook** in CFF,     |
|                        |                          | assess if                |
|                        |                          | [section]{.underline} or |
|                        |                          | [start]{.unde            |
|                        |                          | rline}-[end]{.underline} |
...
| **year\***             | [year]{.underline}       |                          |
+------------------------+--------------------------+--------------------------+
| **chapter\***          | [section]{.underline}    | Only required on         |
|                        |                          | **\@inbook**             |
+------------------------+--------------------------+--------------------------+
| **pages\***            | [start]{.underline} and  | Only required on         |
|                        | [end]{.underline}        | **\@inbook**             |
+------------------------+--------------------------+--------------------------+
| **volume**             | [volume]{.underline}     |                          |
+------------------------+--------------------------+--------------------------+
| **number**             | [issue]{.underline}      |                          |
+------------------------+--------------------------+--------------------------+
| **series**             | [colle                   |                          |
|                        | ction-title]{.underline} |                          |
+------------------------+--------------------------+--------------------------+
| **address**            | [address]{.underline}    | As a fallback, the field |
|                        | property of              | [location]{.underline}   |
|                        | [publisher]{.underline}  | can be used              |
+------------------------+--------------------------+--------------------------+
| **edition**            | [edition]{.underline}    |                          |
+------------------------+--------------------------+--------------------------+
| **month**              | [month]{.underline}      | See **Note** on          |
|                        |                          | [article]                |
+------------------------+--------------------------+--------------------------+
| **note**               | [notes]{.underline}      |                          |
+------------------------+--------------------------+--------------------------+
...
|                             | ion]{.underline} |                            |
+-----------------------------+------------------+----------------------------+
| **month**                   | [mo              | See **Note** on [article]  |
|                             | nth]{.underline} |                            |
+-----------------------------+------------------+----------------------------+
| **year**                    | [y               | As a fallback, **year**    |
|                             | ear]{.underline} | could be extracted also    |
|                             |                  | from **date** (BibLaTeX    |
|                             |                  | field)/                    |
|                             |                  | [d                         |
|                             |                  | ate-published]{.underline} |
+-----------------------------+------------------+----------------------------+
| **note**                    | [no              |                            |
|                             | tes]{.underline} |                            |
+-----------------------------+------------------+----------------------------+
...
as BibTeX does not prescribe the use of **institution** on these entries.

+-------------------------+---------------------------+-----------------------+
| BibTeX                  | CFF                       | Note                  |
+=========================+===========================+=======================+
| **\@conference /        | [type:                    | CFF entries with      |
| \@inproceedings**       | conf                      | [type]{.underline}    |
|                         | erence-paper]{.underline} | =conference are       |
|                         |                           | mapped back to        |
|                         |                           | **\@inproceedings**.  |
+-------------------------+---------------------------+-----------------------+
| **author\***            | [authors]{.underline}     |                       |
...
+-------------------------+---------------------------+-----------------------+
| **pages**               | [start]{.underline} and   | See **Note** on       |
|                         | [end]{.underline}         | [article]             |
+-------------------------+---------------------------+-----------------------+
...
| **BibTeX**              | CFF                     | Note                    |
+=========================+=========================+=========================+
| **\@incollection**      | [type:                  | Including a             |
|                         | generic]{.underline}    | [collec                 |
|                         |                         | tion-title]{.underline} |
|                         |                         | value                   |
+-------------------------+-------------------------+-------------------------+
| **author\***            | [authors]{.underline}   |                         |
+-------------------------+-------------------------+-------------------------+
...
|                         | [end]{.underline}       | [article]               |
+-------------------------+-------------------------+-------------------------+
| **address**             | [address]{.underline}   | See **Note** on         |
...
|                          |                             | [article]           |
+--------------------------+-----------------------------+---------------------+
| **year**                 | [year]{.underline}          | See **Note** on     |
|                          |                             | [booklet]           |
+--------------------------+-----------------------------+---------------------+
| **note**                 | [notes]{.underline}         |                     |
+--------------------------+-----------------------------+---------------------+
...
[thesis-type]{.underline} (CFF). So if [thesis-type]{.underline} contains a
[regex pattern](https://regex101.com/r/mBWfbs/1) `(?i)(phd)` it would be
recognized as **\@phdthesis**.

+---------------------------+----------------------+---------------------------+
| BibTeX                    | CFF                  | Note                      |
+===========================+======================+===========================+
| **\@mastersthesis**       | [type:               | Use also                  |
|                           | thesis]{.underline}  | [thesis-type]{.underline} |
|                           |                      | for identifying the       |
|                           |                      | thesis type.              |
+---------------------------+----------------------+---------------------------+
| **\@phdthesis**           | [type:               | Use also                  |
|                           | thesis]{.underline}  | [thesis-type]{.underline} |
|                           |                      | for identifying the       |
|                           |                      | thesis type.              |
+---------------------------+----------------------+---------------------------+
...
Note als that it is mapped to [type: generic]{.underline} as [incollection], but
in this case **booktitle** is not even an option, so the proposed definition
...
[authors]{.underline} is required on CFF, we would use *anonymous*[^9] when
converting to CFF and omit it on the conversion back to CFF.
